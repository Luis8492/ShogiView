...
- Explore branching variations in an SVG tree view below the board, click nodes to jump, and scroll with the mouse wheel (Shift+wheel for horizontal) to move around
