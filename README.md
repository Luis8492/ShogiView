...
- Explore variations in an SVG tree view and drag the background to pan across it
...
4. Open the note in Reading view to see the board, captured pieces, and the variation tree. Use the controls or the tree nodes to replay the game. Drag the tree background to pan, and click inside the viewer once (or focus its controls) to enable keyboard shortcuts such as ←/→, Home/End, and Space.
