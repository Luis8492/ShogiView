...
- View a move tree diagram under the board with horizontal move order and vertical variation branches
- Click move boxes to jump to any position, and drag the background to pan the tree
...
- Expands branches that begin with `変化：n手` into a tree diagram so you can move to any variation.
